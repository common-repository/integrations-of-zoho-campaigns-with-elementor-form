<?php
namespace FormInteg\IZCEF\Core\Hooks;

use FormInteg\IZCEF\Core\Util\Request;
use FormInteg\IZCEF\Admin\AdminAjax;
...
class HookService
{
    ...
    {
        if (Request::Check('ajax') && is_readable(IZCEF_PLUGIN_BASEDIR . 'includes' . DIRECTORY_SEPARATOR . 'Routes' . DIRECTORY_SEPARATOR . 'ajax.php')) {
            include IZCEF_PLUGIN_BASEDIR . 'includes' . DIRECTORY_SEPARATOR . 'Routes' . DIRECTORY_SEPARATOR . 'ajax.php';
        }
        if (is_readable(IZCEF_PLUGIN_BASEDIR . 'includes' . DIRECTORY_SEPARATOR . 'hooks.php')) {
            include IZCEF_PLUGIN_BASEDIR . 'includes' . DIRECTORY_SEPARATOR . 'hooks.php';
        }
    }
    ...
    {
        $task_dir = IZCEF_PLUGIN_BASEDIR . 'includes' . DIRECTORY_SEPARATOR . $task_name;
    ...
    {
        if (is_readable(IZCEF_PLUGIN_BASEDIR . 'includes' . DIRECTORY_SEPARATOR . 'Routes' . DIRECTORY_SEPARATOR . 'api.php')) {
            include IZCEF_PLUGIN_BASEDIR . 'includes' . DIRECTORY_SEPARATOR . 'Routes' . DIRECTORY_SEPARATOR . 'api.php';
        }
    }
}
