<?php
namespace FormInteg\IZCEF\Triggers\Elementor;
...
final class ElementorController
{
    ...
    public function getAllForms()
    {
        if (!self::pluginActive()) {
            wp_send_json_error(__('Elementor Pro is not installed or activated', 'elementor-to-zoho-campaigns'));
        }
    ...
    public function getFormFields($data)
    {
        ...
        if (empty($data->id) && empty($data->postId)) {
            wp_send_json_error(__('Form doesn\'t exists', 'elementor-to-zoho-campaigns'));
        }

        $fields = self::fields($data);
        if (empty($fields)) {
            wp_send_json_error(__('Form doesn\'t exists any field', 'elementor-to-zoho-campaigns'));
        }
